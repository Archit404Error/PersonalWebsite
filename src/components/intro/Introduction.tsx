...
export const Introduction = () => {
  return (
    <div className="grid grid-cols-12 pt-20 pl-20 bg-gradient-to-br from-[#011f3d] via-[#1d4975] to-[#366a9e] z-10 w-full h-screen">
      <div className="col-start-3 col-span-8 flex gap-8 flex-col">
        <RevealWrapper delay={0} origin="left">
          <h1 className="text-8xl font-medium">Hi, I&apos;m Archit!</h1>
        </RevealWrapper>
